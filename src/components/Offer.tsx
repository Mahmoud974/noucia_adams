...
const Offer = () => {
  ...
  return (
    <div className="bg-amber-400 xl:h-44 h-24 flex xl:flex-row xl:justify-center xl:space-x-20 flex-col ">
        ...
        <div className="text-black xl:text-left text-center mt-2" data-aos='fade-right'>
            <h2 className="font-bold xl:text-8xl text-2xl font-['Judson','serif']  ">Offre de 20%</h2>
            <p className="text-sm ">
